    ...
    return (
        <div>
            <div className='md:flex justify-evenly gap-10'>
                ...
                <div>
                    <h1 className='text-justify'>I am Junaid Ahamed Jesan a Frontend Developer or Web Developer. I'm so foodie person, i love to eat food and my hobbies are Skiing, Dibing, Sleeping, Astrography, Skydiving. I love to enjoy my life with my Parents Friends and Relatives. i love my mother most like what i did or what i am doing all this is only for my mother happiness. And my last massage for all is <strong>Bepar Na</strong>.</h1>
                </div>
            </div>
            <div className='md:flex mx-auto gap-12 mt-10'>
                ...
                <div className='w-full md:w-2/3'>
                    <h1 className='text-2xl font-semibold'>Web Developer / Frontend Developer</h1>
